Credits_Header:
	...
	sHeaderFM	Credits_FM1, $00, $12
	sHeaderFM	Credits_FM2, $F4, $19
	sHeaderFM	Credits_FM3, $F4, $18
	sHeaderFM	Credits_FM4, $00, $13
	sHeaderFM	Credits_FM5, $00, $12
	sHeaderPSG	Credits_PSG1, $DC-12, $02, 0, 0
	sHeaderPSG	Credits_PSG2, $DC-12, $02, 0, 0
	sHeaderPSG	Credits_PSG3, $23, $02, 0, 0
...
Credits_Jump6:
	...
	dc.b nRst, $12, nG4, $06, nRst, $12, nBb4, $0C
	dc.b sHold, $60
	saTranspose	$F4
	saVolPSG	$FF
	dc.b nRst, nRst
...
Credits_Jump7:
	...
	dc.b nG5, $0C, nFs5, $0C, sHold, nFs5, $60, nRst
	saVolPSG	$02
	saTranspose	$0C
	saVolPSG	$01
	dc.b nRst, $02, nC5, nD5, nE5, $12, nD5, $0C
	...
	dc.b $0C, nD5, $3C, nRst, $02, nC5, nD5, nE5
	dc.b $12, nD5, $0C, nC5, $06, nRst, $12, nD5
	dc.b $06, nRst, $12, nE5, $0C
	saTranspose	$F4
	saVolPSG	$FF
	dc.b sHold, $60, nRst, nRst
	sJump		Credits_Jump7
...
Credits_Loop3:
	sCall		Credits_Call1
	sLoop		$00, $03, Credits_Loop3
	sCall		Credits_Call4
	sCall		Credits_Call6

Credits_Loop4:
	sCall		Credits_Call1
	sLoop		$00, $03, Credits_Loop4
	sCall		Credits_Call4
	sCall		Credits_Call7
	sJump		Credits_Loop2
...
Credits_DAC1:
	dc.b nRst, $60
	sLoop		$00, $07, Credits_DAC1
	dc.b nRst, $30, dSnare, $12, $18, $06
...
Credits_Call8:
	dc.b dKick, $0C, dFloorTimpani, $0C, dSnare, $12, dKick, $06
	dc.b $0C, $0C, dSnare, $06, dFloorTimpani, $12, dKick, $18
	dc.b dSnare, $12, dKick, $06, $0C, $0C, dSnare, $06
	dc.b dFloorTimpani, $12, dKick, $0C, dFloorTimpani, $0C, dSnare, $12
	dc.b dKick, $06, $0C, $0C, dSnare, $06, dFloorTimpani, $12
	sRet

Credits_Call9:
	dc.b dKick, $18, dSnare, $12, dKick, $06, $0C, $0C
	dc.b dSnare, $06, dFloorTimpani, $0C, dSnare, $06
	sRet

Credits_Call10:
	dc.b dKick, $18, dSnare, $12, dKick, $06, $0C, $06
	dc.b dSnare, $06, dSnare, $06, dFloorTimpani, $0C, dSnare, $06
	sRet

Credits_Call11:
	dc.b dKick, $0C, dSnare, $0C, dSnare, $12, dKick, $06
	dc.b $0C, $06, dSnare, $06, dSnare, $06, dSnare, $12
	sRet

Credits_Call12:
	dc.b dKick, $0C, dSnare, $0C, dSnare, $12, dKick, $06
	dc.b $06, dSnare, $06, dKick, $0C, dSnare, $06, dFloorTimpani
	dc.b $0C, dSnare, $06
	sRet
